    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(sixth.this,"Fields are required ",Toast.LENGTH_SHORT).show();
                    flag1=0;
                    flag2=0;
                ...
                if(flag1==1 && flag2==1 ){
                    ...
                    if (mUploadTask != null && mUploadTask.isInProgress()) {
                        Toast.makeText(sixth.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                    } else {
                        if (mImageUri != null) {
                            ...
                            Task<Uri> mUploadTask=fileReference.putFile(mImageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(sixth.this, "Upload successful", Toast.LENGTH_LONG).show();
                                        Uri downloadUrl = task.getResult();
                                        String d=downloadUrl.toString();
                                        Toast.makeText(sixth.this, "Complain sent ", Toast.LENGTH_SHORT).show();
                                        ...
                                        Intent i = new Intent(sixth.this, cl.class);
                                        startActivity(i);
                        ...
                        {
                            Toast.makeText(sixth.this, "no image selected", Toast.LENGTH_LONG).show();
        ...
        loct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
                    ...
                    if (ActivityCompat.checkSelfPermission(sixth.this, Manifest.permission.ACCESS_FINE_LOCATION)
                            != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                            (sixth.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

                        ActivityCompat.requestPermissions(sixth.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
