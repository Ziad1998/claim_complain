...
public class thirdc extends AppCompatActivity  {
    ...
    Button loct,save;
    String type="Tresspass";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thirdc);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(thirdc.this,"Fields are required ",Toast.LENGTH_SHORT).show();
                    flag1=0;
                    flag2=0;
                ...
                if(flag1==1 && flag2==1){
                    ...
                    if (mUploadTask2 != null && mUploadTask2.isInProgress() ) {
                        Toast.makeText(thirdc.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                    } else {
                            ...
                            Task<Uri> mUploadTask=fileReference2.putFile(mImageUri2).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(thirdc.this, "Upload successful", Toast.LENGTH_LONG).show();
                                        Uri downloadUrl2 = task.getResult();
                                        String d2=downloadUrl2.toString();
                                        Toast.makeText(thirdc.this, "Complain sent ", Toast.LENGTH_SHORT).show();
                                        ...
                                        Intent i = new Intent(thirdc.this, CC.class);
                                        startActivity(i);
                        ...
                        {
                            Toast.makeText(thirdc.this, "no image selected", Toast.LENGTH_LONG).show();
                            ...
                            Task<Uri> mUploadTask=fileReference.putFile(mImageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Intent i = new Intent(thirdc.this, cl.class);
                                        startActivity(i);
        ...
        loct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
                    ...
                    if (ActivityCompat.checkSelfPermission(thirdc.this, Manifest.permission.ACCESS_FINE_LOCATION)
                            != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                            (thirdc.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

                        ActivityCompat.requestPermissions(thirdc.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
