    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(forth.this,"Fields are required ",Toast.LENGTH_SHORT).show();
                    flag1=0;
                    flag2=0;
                ...
                if(flag1==1 && flag2==1 ){
                    ...
                    if (mUploadTask != null && mUploadTask.isInProgress()) {
                        Toast.makeText(forth.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                    } else {
                        if (mImageUri != null) {
                            ...
                            Task<Uri> mUploadTask=fileReference.putFile(mImageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(forth.this, "Upload successful", Toast.LENGTH_LONG).show();
                                        Uri downloadUrl = task.getResult();
                                        String d=downloadUrl.toString();
                                        Toast.makeText(forth.this, "Complain sent ", Toast.LENGTH_SHORT).show();
                                        ...
                                        Intent i = new Intent(forth.this, cl.class);
                                        startActivity(i);
                        ...
                        {
                            Toast.makeText(forth.this, "no image selected", Toast.LENGTH_LONG).show();
        ...
        loct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
                    ...
                    if (ActivityCompat.checkSelfPermission(forth.this, Manifest.permission.ACCESS_FINE_LOCATION)
                            != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                            (forth.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

                        ActivityCompat.requestPermissions(forth.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
