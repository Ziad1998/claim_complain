...
public class firstc extends AppCompatActivity  {
    ...
    Button loct,save;
    String type="Murder Case";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_firstc);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(firstc.this,"Fields are required ",Toast.LENGTH_SHORT).show();
                    flag1=0;
                    flag2=0;
                ...
                if(flag1==1 && flag2==1){
                    ...
                    if (mUploadTask2 != null && mUploadTask2.isInProgress() ) {
                        Toast.makeText(firstc.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                    } else {
...
flag3=1;
                mUploadTask2 = fileReference2.putFile(mImageUri2);
                            ...
                            Task<Uri> mUploadTask=fileReference2.putFile(mImageUri2).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(firstc.this, "Upload successful", Toast.LENGTH_LONG).show();
                                        Uri downloadUrl2 = task.getResult();
                                        String d2=downloadUrl2.toString();
                                        Toast.makeText(firstc.this, "Complain sent ", Toast.LENGTH_SHORT).show();
                        ...
                        {
                            Toast.makeText(firstc.this, "no image selected", Toast.LENGTH_LONG).show();
                            ...
                            Task<Uri> mUploadTask=fileReference.putFile(mImageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Intent i = new Intent(firstc.this, CC.class);
                                        startActivity(i);
        ...
        loct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
                    ...
                    if (ActivityCompat.checkSelfPermission(firstc.this, Manifest.permission.ACCESS_FINE_LOCATION)
                            != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                            (firstc.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

                        ActivityCompat.requestPermissions(firstc.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
