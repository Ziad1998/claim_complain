    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(secondc.this,"Fields are required ",Toast.LENGTH_SHORT).show();
                    flag1=0;
                    flag2=0;
                ...
                if(flag1==1 && flag2==1){
                    ...
                    if (mUploadTask2 != null && mUploadTask2.isInProgress() ) {
                        Toast.makeText(secondc.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                    } else {
                            ...
                            Task<Uri> mUploadTask=fileReference2.putFile(mImageUri2).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(secondc.this, "Upload successful", Toast.LENGTH_LONG).show();
                                        Uri downloadUrl2 = task.getResult();
                                        String d2=downloadUrl2.toString();
                                        Toast.makeText(secondc.this, "Complain sent ", Toast.LENGTH_SHORT).show();
                                        ...
                                        Intent i = new Intent(secondc.this, CC.class);
                                        startActivity(i);
                        ...
                        {
                            Toast.makeText(secondc.this, "no image selected", Toast.LENGTH_LONG).show();
        ...
        loct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
                    ...
                    if (ActivityCompat.checkSelfPermission(secondc.this, Manifest.permission.ACCESS_FINE_LOCATION)
                            != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                            (secondc.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

                        ActivityCompat.requestPermissions(secondc.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
