...
public class Detailedc2 extends AppCompatActivity {
    TextView reply,stat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase= FirebaseDatabase.getInstance().getReference("Claims").child(v).child(c);
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Detailedc2.this, "Opsss.... Something is wrong", Toast.LENGTH_SHORT).show();
