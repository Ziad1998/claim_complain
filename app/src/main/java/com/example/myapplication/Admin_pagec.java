...
public class Admin_pagec extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_pagec);
        ...
        buttonfeed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getBaseContext(),feedbackc.class);
        ...
        buttonlogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i= new Intent(Admin_pagec.this,LoginC.class);
                startActivity(i);
